...
export const MODULOS_ESP32 = [
    {
        ...
        observacoes: [
            ...
            '38-espc: a calibracao do Alerta de Nivel e EDITAVEL pelo site (Configuracoes -> Sensores & Telemetria), salva na NVS do ESP32 — nao precisa mais reflashar pra reajustar. 40-espc: a logica foi INVERTIDA — agora e um alarme de TRANSBORDAMENTO (nivel alto demais), nao mais de nivel baixo, complementando o Nivel de Agua via ultrassom que ja cobre leitura precisa de nivel baixo/normal. Deteccao de vazamento continua com limiar fixo no codigo, ainda precisa de calibracao manual/reflash.',
